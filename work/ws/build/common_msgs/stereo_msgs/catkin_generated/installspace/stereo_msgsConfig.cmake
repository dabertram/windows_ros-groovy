...
if(NOT "C:/opt/ros/groovy/x86/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY C:/opt/ros/groovy/x86/${idir})
      ...
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/groovy/x86/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
set(pkg_cfg_extras "C:/opt/ros/groovy/x86/share/stereo_msgs/cmake/stereo_msgs-msg-extras.cmake")
