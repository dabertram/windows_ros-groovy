...
if(NOT "C:/work/ws/devel/include;C:/work/ws/src/ros_comm/tools/topic_tools/include" STREQUAL "")
  set(topic_tools_INCLUDE_DIRS "")
  set(absolute_include_dirs "C:/work/ws/devel/include;C:/work/ws/src/ros_comm/tools/topic_tools/include")
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros_comm/tools/topic_tools/${idir})
      set(include C:/work/ws/src/ros_comm/tools/topic_tools/${idir})
    else()
      message(FATAL_ERROR "Project 'topic_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros_comm/tools/topic_tools/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
set(pkg_cfg_extras "C:/work/ws/devel/share/topic_tools/cmake/topic_tools-msg-extras.cmake")
