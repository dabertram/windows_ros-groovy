...
if(TRUE)
  set(rosgraph_SOURCE_PREFIX C:/work/ws/src/ros_comm/tools/rosgraph)
  set(rosgraph_DEVEL_PREFIX C:/work/ws/devel)
  set(rosgraph_INSTALL_PREFIX "")
  set(rosgraph_PREFIX ${rosgraph_DEVEL_PREFIX})
else()
  set(rosgraph_SOURCE_PREFIX "")
  set(rosgraph_DEVEL_PREFIX "")
  set(rosgraph_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros_comm/tools/rosgraph/${idir})
      set(include C:/work/ws/src/ros_comm/tools/rosgraph/${idir})
    else()
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros_comm/tools/rosgraph/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rosgraph_LIBRARIES ${${rosgraph_dep}_LIBRARIES})
...
if(rosgraph_LIBRARIES)
  _remove_duplicate_libraries(rosgraph_LIBRARIES rosgraph_LIBRARIES)
endif()
