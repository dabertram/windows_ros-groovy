...
if(TRUE)
  set(stereo_msgs_SOURCE_PREFIX C:/work/ws/src/common_msgs/stereo_msgs)
  set(stereo_msgs_DEVEL_PREFIX C:/work/ws/devel)
  ...
  set(stereo_msgs_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "C:/work/ws/devel/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/common_msgs/stereo_msgs/${idir})
      set(include C:/work/ws/src/common_msgs/stereo_msgs/${idir})
    else()
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/common_msgs/stereo_msgs/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND stereo_msgs_LIBRARIES ${${stereo_msgs_dep}_LIBRARIES})
...
if(stereo_msgs_LIBRARIES)
  _remove_duplicate_libraries(stereo_msgs_LIBRARIES stereo_msgs_LIBRARIES)
endif()

set(pkg_cfg_extras "C:/work/ws/devel/share/stereo_msgs/cmake/stereo_msgs-msg-extras.cmake")
