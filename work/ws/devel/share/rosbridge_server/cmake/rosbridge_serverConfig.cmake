...
if(TRUE)
  set(rosbridge_server_SOURCE_PREFIX C:/work/ws/src/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX C:/work/ws/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/rosbridge_suite/rosbridge_server/${idir})
      set(include C:/work/ws/src/rosbridge_suite/rosbridge_server/${idir})
    else()
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/rosbridge_suite/rosbridge_server/${idir}'.  Ask the maintainer 'Brandon Alexander <baalexander@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rosbridge_server_LIBRARIES ${${rosbridge_server_dep}_LIBRARIES})
...
if(rosbridge_server_LIBRARIES)
  _remove_duplicate_libraries(rosbridge_server_LIBRARIES rosbridge_server_LIBRARIES)
endif()
