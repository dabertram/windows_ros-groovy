...
if(TRUE)
  set(rosmake_SOURCE_PREFIX C:/work/ws/src/ros/tools/rosmake)
  set(rosmake_DEVEL_PREFIX C:/work/ws/devel)
  set(rosmake_INSTALL_PREFIX "")
  set(rosmake_PREFIX ${rosmake_DEVEL_PREFIX})
else()
  set(rosmake_SOURCE_PREFIX "")
  set(rosmake_DEVEL_PREFIX "")
  set(rosmake_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros/tools/rosmake/${idir})
      set(include C:/work/ws/src/ros/tools/rosmake/${idir})
    else()
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros/tools/rosmake/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rosmake_LIBRARIES ${${rosmake_dep}_LIBRARIES})
...
if(rosmake_LIBRARIES)
  _remove_duplicate_libraries(rosmake_LIBRARIES rosmake_LIBRARIES)
endif()
