...
if(TRUE)
  set(test_rosmaster_SOURCE_PREFIX C:/work/ws/src/ros_comm/test/test_rosmaster)
  set(test_rosmaster_DEVEL_PREFIX C:/work/ws/devel)
  ...
  set(test_rosmaster_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "C:/work/ws/devel/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros_comm/test/test_rosmaster/${idir})
      set(include C:/work/ws/src/ros_comm/test/test_rosmaster/${idir})
    else()
      message(FATAL_ERROR "Project 'test_rosmaster' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros_comm/test/test_rosmaster/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
set(pkg_cfg_extras "C:/work/ws/devel/share/test_rosmaster/cmake/test_rosmaster-msg-extras.cmake")
