...
if(TRUE)
  set(rosnode_SOURCE_PREFIX C:/work/ws/src/ros_comm/tools/rosnode)
  set(rosnode_DEVEL_PREFIX C:/work/ws/devel)
  set(rosnode_INSTALL_PREFIX "")
  set(rosnode_PREFIX ${rosnode_DEVEL_PREFIX})
else()
  set(rosnode_SOURCE_PREFIX "")
  set(rosnode_DEVEL_PREFIX "")
  set(rosnode_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros_comm/tools/rosnode/${idir})
      set(include C:/work/ws/src/ros_comm/tools/rosnode/${idir})
    else()
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros_comm/tools/rosnode/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rosnode_LIBRARIES ${${rosnode_dep}_LIBRARIES})
...
if(rosnode_LIBRARIES)
  _remove_duplicate_libraries(rosnode_LIBRARIES rosnode_LIBRARIES)
endif()
