...
if(NOT "C:/work/ws/src/ros_comm/tools/rosconsole/include;C:/opt/rosdeps/groovy/x86/share/boost-1.47.0/cmake/../../../include;C:/opt/rosdeps/groovy/x86/share/cmake/log4cxx/../../../include" STREQUAL "")
  set(rosconsole_INCLUDE_DIRS "")
  set(absolute_include_dirs "C:/work/ws/src/ros_comm/tools/rosconsole/include;C:/opt/rosdeps/groovy/x86/share/boost-1.47.0/cmake/../../../include;C:/opt/rosdeps/groovy/x86/share/cmake/log4cxx/../../../include")
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros_comm/tools/rosconsole/${idir})
      set(include C:/work/ws/src/ros_comm/tools/rosconsole/${idir})
    else()
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros_comm/tools/rosconsole/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
set(pkg_cfg_extras "C:/work/ws/src/ros_comm/tools/rosconsole/cmake/rosconsole-extras.cmake")
