...
if(TRUE)
  set(rosbash_SOURCE_PREFIX C:/work/ws/src/ros/tools/rosbash)
  set(rosbash_DEVEL_PREFIX C:/work/ws/devel)
  set(rosbash_INSTALL_PREFIX "")
  set(rosbash_PREFIX ${rosbash_DEVEL_PREFIX})
else()
  set(rosbash_SOURCE_PREFIX "")
  set(rosbash_DEVEL_PREFIX "")
  set(rosbash_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros/tools/rosbash/${idir})
      set(include C:/work/ws/src/ros/tools/rosbash/${idir})
    else()
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros/tools/rosbash/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rosbash_LIBRARIES ${${rosbash_dep}_LIBRARIES})
...
if(rosbash_LIBRARIES)
  _remove_duplicate_libraries(rosbash_LIBRARIES rosbash_LIBRARIES)
endif()
