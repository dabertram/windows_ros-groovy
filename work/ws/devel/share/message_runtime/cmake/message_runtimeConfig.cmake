...
if(TRUE)
  set(message_runtime_SOURCE_PREFIX C:/work/ws/src/message_runtime)
  set(message_runtime_DEVEL_PREFIX C:/work/ws/devel)
  ...
  set(message_runtime_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/message_runtime/${idir})
      set(include C:/work/ws/src/message_runtime/${idir})
    else()
      message(FATAL_ERROR "Project 'message_runtime' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/message_runtime/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND message_runtime_LIBRARIES ${${message_runtime_dep}_LIBRARIES})
...
if(message_runtime_LIBRARIES)
  _remove_duplicate_libraries(message_runtime_LIBRARIES message_runtime_LIBRARIES)
endif()
