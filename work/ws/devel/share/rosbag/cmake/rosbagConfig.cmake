...
if(TRUE)
  set(rosbag_SOURCE_PREFIX C:/work/ws/src/ros_comm/tools/rosbag)
  set(rosbag_DEVEL_PREFIX C:/work/ws/devel)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "C:/work/ws/src/ros_comm/tools/rosbag/include" STREQUAL "")
  set(rosbag_INCLUDE_DIRS "")
  set(absolute_include_dirs "C:/work/ws/src/ros_comm/tools/rosbag/include")
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros_comm/tools/rosbag/${idir})
      set(include C:/work/ws/src/ros_comm/tools/rosbag/${idir})
    else()
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros_comm/tools/rosbag/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
set(depends "rosconsole;roscpp;topic_tools;xmlrpcpp")
foreach(depend ${depends})
  ...
  list(APPEND rosbag_LIBRARIES ${${rosbag_dep}_LIBRARIES})
...
if(rosbag_LIBRARIES)
  _remove_duplicate_libraries(rosbag_LIBRARIES rosbag_LIBRARIES)
endif()
