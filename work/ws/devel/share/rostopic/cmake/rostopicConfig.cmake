...
if(TRUE)
  set(rostopic_SOURCE_PREFIX C:/work/ws/src/ros_comm/tools/rostopic)
  set(rostopic_DEVEL_PREFIX C:/work/ws/devel)
  set(rostopic_INSTALL_PREFIX "")
  set(rostopic_PREFIX ${rostopic_DEVEL_PREFIX})
else()
  set(rostopic_SOURCE_PREFIX "")
  set(rostopic_DEVEL_PREFIX "")
  set(rostopic_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros_comm/tools/rostopic/${idir})
      set(include C:/work/ws/src/ros_comm/tools/rostopic/${idir})
    else()
      message(FATAL_ERROR "Project 'rostopic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros_comm/tools/rostopic/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rostopic_LIBRARIES ${${rostopic_dep}_LIBRARIES})
...
if(rostopic_LIBRARIES)
  _remove_duplicate_libraries(rostopic_LIBRARIES rostopic_LIBRARIES)
endif()
