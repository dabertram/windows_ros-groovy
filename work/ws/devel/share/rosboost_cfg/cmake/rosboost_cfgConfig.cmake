...
if(TRUE)
  set(rosboost_cfg_SOURCE_PREFIX C:/work/ws/src/ros/tools/rosboost_cfg)
  set(rosboost_cfg_DEVEL_PREFIX C:/work/ws/devel)
  ...
  set(rosboost_cfg_INSTALL_PREFIX C:/opt/ros/groovy/x86)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/ws/src/ros/tools/rosboost_cfg/${idir})
      set(include C:/work/ws/src/ros/tools/rosboost_cfg/${idir})
    else()
      message(FATAL_ERROR "Project 'rosboost_cfg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/ws/src/ros/tools/rosboost_cfg/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rosboost_cfg_LIBRARIES ${${rosboost_cfg_dep}_LIBRARIES})
...
if(rosboost_cfg_LIBRARIES)
  _remove_duplicate_libraries(rosboost_cfg_LIBRARIES rosboost_cfg_LIBRARIES)
endif()
