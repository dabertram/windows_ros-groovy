...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.result.map.header.seq, _x.action_result.result.map.header.stamp.secs, _x.action_result.result.map.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.map.header.seq, _x.action_result.result.map.header.stamp.secs, _x.action_result.result.map.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.map.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.action_result.result.map.data = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
