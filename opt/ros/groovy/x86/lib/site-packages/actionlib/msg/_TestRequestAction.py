...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_iB.pack(_x.action_goal.goal.terminate_status, _x.action_goal.goal.ignore_cancel))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_iB6i3I.pack(_x.action_goal.goal.the_result, _x.action_goal.goal.is_simple_client, _x.action_goal.goal.delay_accept.secs, _x.action_goal.goal.delay_accept.nsecs, _x.action_goal.goal.delay_terminate.secs, _x.action_goal.goal.delay_terminate.nsecs, _x.action_goal.goal.pause_status.secs, _x.action_goal.goal.pause_status.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_iB3I.pack(_x.action_result.result.the_result, _x.action_result.result.is_simple_server, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.terminate_status, _x.action_goal.goal.ignore_cancel,) = _struct_iB.unpack(str[start:end])
      ...
      if python3:
        self.action_goal.goal.result_text = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.result_text = str[start:end]
      _x = self
      start = end
      end += 41
      (_x.action_goal.goal.the_result, _x.action_goal.goal.is_simple_client, _x.action_goal.goal.delay_accept.secs, _x.action_goal.goal.delay_accept.nsecs, _x.action_goal.goal.delay_terminate.secs, _x.action_goal.goal.delay_terminate.nsecs, _x.action_goal.goal.pause_status.secs, _x.action_goal.goal.pause_status.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_iB6i3I.unpack(str[start:end])
      ...
      (_x.action_result.result.the_result, _x.action_result.result.is_simple_server, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_iB3I.unpack(str[start:end])
