...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_iB.pack(_x.result.the_result, _x.result.is_simple_server))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.the_result, _x.result.is_simple_server,) = _struct_iB.unpack(str[start:end])
