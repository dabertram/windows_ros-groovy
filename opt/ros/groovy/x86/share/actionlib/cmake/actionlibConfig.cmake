...
if(NOT "C:/opt/ros/groovy/x86/include;C:/opt/rosdeps/groovy/x86/share/boost-1.47.0/cmake/../../../include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY C:/opt/ros/groovy/x86/${idir})
      ...
      message(FATAL_ERROR "Project 'actionlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/groovy/x86/${idir}'.  Ask the maintainer 'Eitan Marder-Eppstein <eitan@willowgarage.com>' to fix it.")
    endif()
...
set(pkg_cfg_extras "C:/opt/ros/groovy/x86/share/actionlib/cmake/actionlib-msg-extras.cmake")
